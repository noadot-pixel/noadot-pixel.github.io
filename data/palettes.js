...
export const uplaceColors = [
    ...
    {rgb:[45,34,28], name:"dark espresso"}, {rgb:[36,36,36], name:"dark grey"}, {rgb:[26,28,44], name:"void"}, 
    {rgb:[29,20,39], name:"midnight violet"}, {rgb:[31,16,69], name:"midnight purple"}, {rgb:[36,36,64], name:"dark navy"}, 
    {rgb:[60,58,75], name:"slate blue"}, {rgb:[73,73,73], name:"grey"}, {rgb:[72,107,58], name:"fern green"}, 
    {rgb:[55,84,24], name:"pine"}, {rgb:[16,55,42], name:"deep jungle green"}, {rgb:[0,72,68], name:"dark slate"}, 
    {rgb:[0,117,111], name:"dark teal"}, {rgb:[0,163,104], name:"shamrock"}, {rgb:[0,204,120], name:"bright green"}, 
    {rgb:[56,183,100], name:"slime green"}, {rgb:[82,202,53], name:"mantis green"}, {rgb:[96,151,74], name:"asparagus"}, 
    {rgb:[129,156,45], name:"moss"}, {rgb:[168,130,54], name:"ochre"}, {rgb:[188,111,71], name:"tan"}, 
    {rgb:[159,91,80], name:"terracotta"}, {rgb:[156,84,50], name:"copper"}, {rgb:[119,94,40], name:"olive drab"}, 
    {rgb:[124,63,32], name:"brown"}, {rgb:[92,46,26], name:"cocoa"}, {rgb:[77,43,37], name:"dark leather"}, 
    {rgb:[91,39,49], name:"dark mauve"}, {rgb:[93,39,93], name:"tyrian"}, {rgb:[102,0,102], name:"grape"}, 
    ...
    {rgb:[255,56,129], name:"hot pink"}, {rgb:[255,102,107], name:"salmon"}, {rgb:[239,125,87], name:"coral"}, 
    {rgb:[220,141,95], name:"peach"}, {rgb:[216,157,69], name:"goldenrod"}, {rgb:[194,195,88], name:"lemongrass"}, 
    {rgb:[144,197,115], name:"pistachio"}, {rgb:[167,240,112], name:"chartreuse"}, {rgb:[126,237,86], name:"lime"}, 
    {rgb:[170,216,31], name:"acid green"}, {rgb:[255,214,53], name:"yellow"}, {rgb:[255,227,85], name:"bright yellow"}, 
    {rgb:[255,205,117], name:"mustard"}, {rgb:[255,173,125], name:"light skin"}, {rgb:[252,151,131], name:"light coral"}, 
    {rgb:[255,153,170], name:"pastel pink"}, {rgb:[255,128,174], name:"flamingo pink"}, {rgb:[210,148,170], name:"dusty pink"}, 
    {rgb:[200,151,139], name:"dusty rose"}, {rgb:[204,178,152], name:"sand"}, {rgb:[220,190,183], name:"pale taupe"}, 
    {rgb:[255,189,182], name:"pale salmon"}, {rgb:[251,189,207], name:"cherry blossom"}, {rgb:[252,204,218], name:"cotton candy"}, 
    {rgb:[255,206,199], name:"melon"}, {rgb:[255,209,179], name:"pale skin"}, {rgb:[255,227,192], name:"navajo white"}, 
    {rgb:[237,218,199], name:"almond"}, {rgb:[218,218,218], name:"off white"}, {rgb:[216,218,234], name:"periwinkle mist"}, 
    {rgb:[205,243,255], name:"light cyan"}, {rgb:[193,246,242], name:"ice blue"}, {rgb:[180,210,239], name:"baby blue"}, 
    {rgb:[191,190,225], name:"lavender mist"}, {rgb:[182,182,182], name:"pale grey"}, {rgb:[156,210,188], name:"seafoam"}, 
    {rgb:[167,244,180], name:"mint"}, {rgb:[219,251,181], name:"tea green"}, {rgb:[255,248,184], name:"pale yellow"}, 
    {rgb:[255,224,218], name:"pale peach"}, {rgb:[255,232,231], name:"mist white"}, {rgb:[246,239,231], name:"seashell"}, 
    {rgb:[255,255,255], name:"white"}, {rgb:[228,171,255], name:"lavender"}, {rgb:[208,125,228], name:"light orchid"}, 
    {rgb:[180,74,192], name:"deep purple"}, {rgb:[111,75,204], name:"majestic purple"}, {rgb:[73,58,193], name:"indigo"}, 
    {rgb:[36,80,164], name:"dark blue"}, {rgb:[82,77,120], name:"faded denim"}, {rgb:[109,109,109], name:"medium grey"}, 
    {rgb:[133,132,88], name:"sage"}, {rgb:[156,132,107], name:"taupe"}, {rgb:[146,146,146], name:"light grey"}, 
    {rgb:[137,131,174], name:"heather"}, {rgb:[114,149,248], name:"cornflower"}, {rgb:[148,179,255], name:"sky blue"}, 
    {rgb:[102,203,245], name:"sky cyan"}, {rgb:[81,233,244], name:"cyan"}, {rgb:[66,240,191], name:"bright turquoise"}, 
    {rgb:[0,204,192], name:"aqua"}, {rgb:[0,158,170], name:"teal"}, {rgb:[54,144,234], name:"blue"}, 
    {rgb:[106,92,255], name:"periwinkle"}, {rgb:[37,22,175], name:"ultamarine"}, {rgb:[53,37,132], name:"deep royal blue"}, 
    {rgb:[36,20,98], name:"deep indigo"}, {rgb:[75,0,75], name:"plum"}, {rgb:[51,0,51], name:"deep violet"}, 
    ...
    {rgb:[129,30,9], name:"rust"}, {rgb:[0,41,0], name:"dark forest"}, {rgb:[0,69,0], name:"forest green"}, 
    {rgb:[0,102,0], name:"green"}, {rgb:[0,143,0], name:"kelly green"}, {rgb:[249,128,6], name:"vivid orange"}, 
    {rgb:[255,168,0], name:"orange"}, {rgb:[255,69,0], name:"orange red"}, {rgb:[255,0,0], name:"red"}, 
    {rgb:[238,246,116], name:"pale canary"}
];