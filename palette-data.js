...
const wplaceFreeColorsData = [
  {rgb:[0,0,0], name:"black"}, {rgb:[60,60,60], name:"dark gray"}, {rgb:[120,120,120], name:"gray"}, {rgb:[210,210,210], name:"light gray"}, {rgb:[255,255,255], name:"white"}, {rgb:[96,0,24], name:"deep red"}, {rgb:[239,60,67], name:"red"}, {rgb:[246,170,9], name:"orange"}, {rgb:[249,221,59], name:"yellow"}, {rgb:[255,250,188], name:"light yellow"}, {rgb:[14,185,104], name:"dark green"}, {rgb:[19,230,123], name:"green"}, {rgb:[135,255,94], name:"light green"}, {rgb:[12,129,110], name:"dark teal"}, {rgb:[16,174,166], name:"teal"}, {rgb:[19,225,190], name:"light teal"}, {rgb:[40,80,158], name:"dark blue"}, {rgb:[64,147,228], name:"blue"}, {rgb:[96,247,242], name:"cyan"}, {rgb:[107,80,246], name:"indigo"}, {rgb:[153,117,251], name:"light indigo"}, {rgb:[120,12,153], name:"dark purple"}, {rgb:[170,56,185], name:"purple"}, {rgb:[224,159,249], name:"light purple"}, {rgb:[203,0,112], name:"dark pink"}, {rgb:[236,31,128], name:"pink"}, {rgb:[243,141,169], name:"light pink"}, {rgb:[104,70,52], name:"dark brown"}, {rgb:[149,104,42], name:"brown"}, {rgb:[248,178,119], name:"beige"}
];

const wplacePaidColorsData = [
...
const geoPixelHexCodes = [
    "#FFFFFF", "#F4F59F", "#FFCA3A", "#FF9F1C", "#FF595E", "#E71D36", "#F3BBC2",
    "#FF85A1", "#BD637D", "#CDB4DB", "#6A4C93", "#4D194D", "#A8D0DC", "#2EC4B6",
    "#1A535C", "#6D9DCD", "#1982C4", "#A1C181", "#8AC926", "#A0A0A0", "#6B4226",
    "#505050", "#CFD078", "#145A7A", "#8B1D24", "#C07F7A", "#C49A6C", "#5B7B1C",
    "#000000"
];